const catalogoSanto = {
	...
	"24/1": [{ nombre: "Santa María, Reina De La Paz-San Francisco De Sales-San Francisco De Sales", 	enlace: "/tiempo/santos/enero/24-SANTA MARÍA, REINA DE LA PAZ-SAN FRANCISCO DE SALES-SAN FRANCISCO DE SALES" }],
	...
	// *********************************************************** FEBRERO ***********************************************************
	"1/2": [{ nombre: "La Presentación Del Señor", 											enlace: "/tiempo/santos/febrero/02-LA PRESENTACIÓN DEL SEÑOR" }],
	"2/2": [{ nombre: "Santa Águeda, Virgen Y Mártir", 										enlace: "/tiempo/santos/febrero/04-SANTA ÁGUEDA, virgen y mártir" }],
	"10/2": [{ nombre: "Santa Escolástica de Nursia", 										enlace: "/tiempo/santos/febrero/10-SANTA ESCOLÁSTICA, virgen" }],
	"17/2": [{ nombre: "San Felipe De Jesús", 												enlace: "/tiempo/santos/febrero/05-SAN FELIPE DE JESÚS" }],
	"21/2": [{ nombre: "Santos Pablo Miki Y Compañeros", 									enlace: "/tiempo/santos/febrero/06-SANTOS PABLO MIKI Y COMPAÑEROS" }],
	"24/2": [{ nombre: "Santa Escolástica, Virgen", 										enlace: "/tiempo/santos/febrero/10-SANTA ESCOLÁSTICA, virgen" }],
	"25/2": [{ nombre: "Santos Cirilo, Monje Y Metodio, Obispo", 							enlace: "/tiempo/santos/febrero/14-SANTOS CIRILO, monje y METODIO, obispo" }],
	"26/2": [{ nombre: "La Cátedra De San Pedro, Apóstol", 									enlace: "/tiempo/santos/febrero/22-LA CÁTEDRA DE SAN PEDRO, APÓSTOL" }],
	"28/2": [{ nombre: "San Policarpo, Obispo Y Mártir", 									enlace: "/tiempo/santos/febrero/23-SAN POLICARPO, obispo y mártir" }],
	// *********************************************************** FEBRERO ***********************************************************
	...
	"25/4": [{ nombre: "Nuestra Señora Del Valle", 											enlace: "/tiempo/santos/abril/25-NUESTRA SEÑORA DEL VALLE" }],
	"25/4": [{ nombre: "San Marcos, Evangelista", 											enlace: "/tiempo/santos/abril/25-SAN MARCOS, Evangelista" }],
	...
	"3/5": [{ nombre: "Exaltación De La Santa Cruz", 										enlace: "/tiempo/santos/mayo/03-EXALTACIÓN DE LA SANTA CRUZ" }],
	"3/5": [{ nombre: "Santos Felipe Y Santiago, Apóstoles", 								enlace: "/tiempo/santos/mayo/03-SANTOS FELIPE Y SANTIAGO, apóstoles" }],
	...
	"20/5": [{ nombre: "María, Madre De La Iglesia", 										enlace: "/tiempo/santos/mayo/20-MARÍA, MADRE DE LA IGLESIA" }],
	"26/5": [{ nombre: "San Felipe Neri, Presbítero", 										enlace: "/tiempo/santos/mayo/26-SAN FELIPE NERI, presbítero" }],
	"26/5": [{ nombre: "Santa Mariana De Jesús Paredes, Virgen", 							enlace: "/tiempo/santos/mayo/26-SANTA MARIANA DE JESÚS PAREDES, virgen" }],
	// *********************************************************** MAYO ***********************************************************
	
	// *********************************************************** JUNIO ***********************************************************

	"1/6": [{ nombre: "María, Madre De La Iglesia",                                 		enlace: "/tiempo/santos/junio/01-MARÍA, MADRE DE LA IGLESIA" },
	...
	"20/6": [{ nombre: "El Inmaculado Corazón De La Santísima Virgen María",        		enlace: "/tiempo/santos/junio/20-EL INMACULADO CORAZÓN DE LA SANTÍSIMA VIRGEN MARÍA" }],
	...
	"9/7": [{ nombre: "Nuestra Señora De Itatí", 											enlace: "/tiempo/santos/julio/09-NUESTRA SEÑORA DE ITATÍ" },
	...
	"15/10": [{ nombre: "Santa Teresa De Jesús, Virgen Y Doctora De La Iglesia", 			enlace: "/tiempo/santos/octubre/15-SANTA TERESA DE JESÚS, virgen y doctora de la Iglesia" }],
	...
	"19/11": [{ nombre: "Santa Isabel De Hungría", 											enlace: "/tiempo/santos/noviembre/19-SANTA ISABEL DE HUNGRÍA" },
	...
	"13/12": [{ nombre: "Santa Lucía", 														enlace: "/tiempo/santos/diciembre/13-SANTA LUCÍA" }],
	...
	// *********************************************************** DIFERENTE ***********************************************************
	// FIESTAS QUE NO CAEN EL MISMO DIA, CIERTO TIEMPO DESPUES DE PENTECOSTES
	// *********************************************************** DIFERENTE ***********************************************************

	"31/5": [{ nombre: "La Santísima Trinidad", 											enlace: "/tiempo/santos/junio/07-LA SANTÍSIMA TRINIDAD" }],
	"11/6": [{ nombre: "El Santísimo Cuerpo Y Sangre De Cristo", 							enlace: "/tiempo/santos/junio/14-EL SANTÍSIMO CUERPO Y SANGRE DE CRISTO" }],    // Corpus Christi
	"12/6": [{ nombre: "El Sagrado Corazón De Jesús", 										enlace: "/tiempo/santos/junio/19-EL SAGRADO CORAZÓN DE JESÚS" }],


};

/*		// para días con 2 santos
    "10/8": [	{nombre: "Nuestra Señora De Itatí",enlace: "/tiempo/santos/julio/09-NUESTRA_SEÑORA_DE_ITATÍ"},
